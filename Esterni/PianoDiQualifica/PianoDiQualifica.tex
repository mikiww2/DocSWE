...
\\ Il difetto principale di tale architettura è la duplicazione di codice che interesserà tutti i diversi services che vengono generati durante la codifica del sistema.
