...
\end{figure}
\subsection{\pkg{Q:: Client:: ModelClient}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ModelClient:: Organizations}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Requests}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Services}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Services:: Answers}}
...
restituisce la risposta data dall'utente
\newline
\item \method{setAnswer (answer : bool) : void}
\newline
imposta la risposta data dall'utente
\newline
\bold{Parametri} :
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Services:: Questions}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Statistics}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Client:: ModelClient:: Users}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Client:: ViewClient}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: Shared}}
Contiene componenti condivise da più pagine del sistema, che vengono quindi qui raccolte perché siano accessibili a tutti.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{../SpecificaTecnica/Img/quizzipedia-client-viewclient-shared.pdf}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: Shared:: Header}}
Contiene i template per caricare header e breadcrumb delle pagine a seconda della posizione e del ruolo dell'utente.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{../SpecificaTecnica/Img/quizzipedia-client-viewclient-shared-header.pdf}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: Shared:: Homepage}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewOrgManager}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewQuestionManager}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewQuizManager}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewQuizSolver}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewQuizSolver:: ViewQuestionSolver}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewRequests}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewSearch}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewStatistics}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewTopicManager}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewClient:: ViewUsers}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewModelClient}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlOrganization}}
...
\end{itemize}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlRequests}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlServices}}
...
\end{itemize}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlServices:: CtrlQuestions}}
Raccoglie le classi necessarie al collegamento tra view e model nelle fasi di gestione delle domande.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{../SpecificaTecnica/Img/quizzipedia-client-viewmodelclient-ctrlservices-ctrlquestions.pdf}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlStatistics}}
...
\end{figure}
\subsection{\pkg{Q:: Client:: ViewModelClient:: CtrlUsers}}
...
\caption[Schema Componente Quizzipedia::Client::ViewModelClient::CtrlUsers]{Schema Componente Q:: Client:: ViewModelClient:: CtrlUsers}
\end{figure}
...
\end{figure}
\subsection{\pkg{Q:: Server:: ModelServer}}
...
\end{figure}
\subsection{\pkg{Q:: Server:: ModelServer:: Organizations}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Requests}}
Questo componente contiene le classi necessarie a gestire le richieste di ruolo e di classe degli utenti autenticati.
\begin{figure}[H]
\centering
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Services}}
Il componente racchiude i modelli necessari alla creazione di domande e quiz, i servizi principali offerti dal nostro prodotto.
\begin{figure}[H]
\centering
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Services:: Answers}}
Raccoglie tutte le componenti necessarie alla gestione della verifica dei quiz e delle domande svolte.
\begin{figure}[H]
\centering
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Services:: Questions}}
Descrive il modo in cui sono strutturati i vari tipi di domande che l'utente può incontrare durante la creazione o la compilazione di quiz.
\begin{figure}[H]
\centering
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Statistics}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Server:: ModelServer:: Users}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: AuthenticationManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: ClassManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: InstitutionManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: ProfileManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: QuestionsManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: QuizManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: QuizManager:: QMLAgent}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: RequestsManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: SearchManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: StatisticsManager}}
...
\newline
\end{itemize}
\subsection{\pkg{Q:: Server:: ControllerServer:: TopicManager}}
...
\end{itemize}
\end{itemize}
\subsection{\pkg{Q:: Server:: RoutingManager}}
