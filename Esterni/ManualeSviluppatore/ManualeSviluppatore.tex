...
%	\listoftables
	...
	Per poter avviare il \gl{server} è richiesta una versione Linux \gl{LTS} a 64bit.
	...
	\begin{itemize}
		\item \texttt{mongod} per avviare \gl{mongoDB} nel caso venga utilizzato un database in locale,
