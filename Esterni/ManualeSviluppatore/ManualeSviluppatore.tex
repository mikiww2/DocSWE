...
%	\listoftables
	...
	Scaricare da browser e installare \gl{Node.js} e il package manager \gl{npm} da\\ \url{https://nodejs.org/en/download/current/}.\\
	...
	Si trova al percorso \centra{public/quiz\_execution/CtrlQuizExec.html}
