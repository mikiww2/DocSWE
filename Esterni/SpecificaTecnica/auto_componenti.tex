...
\item usata da \cls{Quizzipedia:: Client:: ModelClient:: Users:: Teacher} per creare nuove domande da parte di un docente
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Client:: ModelClient:: Services:: Questions:: GenericQuestion} per creare nuove domande da parte di un docente
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Client:: ViewModelClient:: CtrlStatistics:: CtrlQuizStatistics} per per permettere all'utente di visualizzare le statistiche generali di un quiz
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Client:: ViewModelClient:: CtrlServices:: CtrlTopics} per per salvare i dati e le modifiche apportate dall'utente agli argomenti
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Client:: ViewModelClient:: CtrlOrganization:: CtrlInstitution} per per poter rimuovere un utente da un istituto
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Client:: ViewModelClient:: CtrlUsers:: CtrlLogin} per per permettere all'utente che sta effettuando il login di selezionare l'ente desiderato
\end{itemize}
...
\item usata da \cls{Quizzipedia:: Client:: ViewClient:: ViewUsers:: RemoveUser} per per poter rimuovere un utente da un istituto
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da \cls{Quizzipedia:: Client:: ViewClient:: ViewTopicManager:: ViewTopicsManager} per per salvare i dati e le modifiche apportate dall'utente agli argomenti
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
...
\item usata da \cls{Quizzipedia:: Client:: ViewModelClient:: CtrlServices:: CtrlQuestions:: MyMultipleChoiceQ} per aggiungere alle funzionalità condivise da tutte le domande quelle proprie della domanda a scelta multipla
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-viewmodelclient-ctrlservices-ctrlquestions-mymultiplechoiceq.pdf}}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da \cls{Quizzipedia:: Client:: ViewClient:: ViewStatistics:: ViewQuizStats} per per permettere all'utente di visualizzare le statistiche generali di un quiz
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
...
\item usata da \cls{Quizzipedia:: Client:: ViewClient:: ViewUsers:: SelectInst} per per permettere all'utente che sta effettuando il login di selezionare l'ente desiderato
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia:: Server:: ControllerServer:: QuizManager:: QMLAgent:: QMLGenerator} per per la trasformazione del quiz che si sta creando da linguaggio HTML a linguaggio QML
\item usa \cls{Quizzipedia:: Server:: ControllerServer:: SessionController} per verificare che l'utente sia un Docente
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da \cls{Quizzipedia:: Server:: ControllerServer:: QuizManager:: QuizCreator} per per la trasformazione del quiz che si sta creando da linguaggio HTML a linguaggio QML
