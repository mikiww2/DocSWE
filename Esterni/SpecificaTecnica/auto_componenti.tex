\subsubsection{Componente Quizzipedia::Client}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Organization::Class}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Requests::ClassList}
...
\end{itemize}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Services::Info}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Services::Questions::Cell}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Statistics::ClassQuiz}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ModelClient::Users::AutheniticationData}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewClassManager::ViewCreateClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewQuestionManager::ViewCreateQuestion}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewQuizManager::ViewCreateQuiz}
...
\end{itemize}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewQuizSolver::ViewResults}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewQuizSolver::ViewQuestionSolver::ViewCompletionQ}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewRequests::RequestClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewSearch::ViewSearchClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewStatistics::VieewQuizStats}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewTopicManager::ViewCreateTopic}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ViewClient::ViewUsers::Login}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ControllerClient::CtrlOrganization::CtrlClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ControllerClient::CtrlRequests::CtrlRequestClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ControllerClient::CtrlServices::CtrlQuestion}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ControllerClient::CtrlStatistics::CtrlStats}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Client::ControllerClient::CtrlUsers::CtrlData}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::AuthenticationManager::LoggerIn}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::ClassManager::AddClass}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::ProfileManager::AccountDeleter}
...
\end{itemize}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::QuizManager::QuizCreator}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::QuizManager::QMLAgent::QMLGenerator}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::RequestsManager::ClassRequestsAdder}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::SearchManager::QuestionSearcher}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::StatisticsManager::PersonalStatisticsFetcher}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::ControllerServer::TopicManager::SessionController8}
...
\end{figure}
\myparagraph{Classe Quizzipedia::Server::RoutingManager::AuthenticationRouter}
