...
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Organization::Institution per memorizzare la lista delle classi presenti in un istituto
...
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organization::Class per memorizzare la lista delle classi presenti in un istituto
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Organization::Institution per gestire la lista delle richieste di accesso a una delle proprie classi
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Organization::Institution per gestire la lista delle richieste di assegnazione di ruolo degli utenti
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organization::Class per tenere traccia delle classi per cui il quiz è stato creato. Se un quiz è assegnato a delle classi specifiche, allora è privato e accessibile dai soli studenti delle classi
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organization::Class per tenere traccia delle classi dell'istituto a cui l'utente è iscritto, o come docente, o come studente
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlUsers::CtrlLogin per visualizzare correttamente il messaggio di errore durante il login
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlUsers::CtrlUserManager per visualizzare correttamente il messaggio di errore in caso di problemi nella modifica della password
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlUsers::CtrlRecoveryPw per visualizzare correttamente il messaggio di errore durante il processo di recupero della password
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlUsers::CtrlRegistration per visualizzare correttamente il messaggio di errore in fase di registrazione
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organization::Class per avere accesso alla struttura della classe e potere quindi svolgere correttamente operazioni su di essa
\item usa Quizzipedia::Client::ModelClient::Organization::Institution per avere accesso alla struttura dell'istituto e caricare correttamente l'istituto corrente
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ViewClient::ViewErrors::ViewAuthenticationErr per visualizzare correttamente il messaggio di errore durante il login
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ViewClient::ViewErrors::ViewRecoveryErr per visualizzare correttamente il messaggio di errore durante il processo di recupero della password
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ViewClient::ViewErrors::ViewRegistrationErr per visualizzare correttamente il messaggio di errore in fase di registrazione
...
\item usa Quizzipedia::Client::ViewClient::ViewErrors::ViewModifyPwErr per visualizzare correttamente il messaggio di errore in caso di problemi nella modifica della password
\end{itemize}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-server-modelserver-organization.pdf}}
