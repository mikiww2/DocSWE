...
\end{itemize}
\subsubsection{Quizzipedia::Client::ModelClient::Organization}
...
\end{itemize}
\myparagraph{Classe Institution}
La classe contiene le informazioni relative alla struttura dell'ente.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-organization-institution.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Organization::Institution}
\end{figure}
\subsubsection{Quizzipedia::Client::ModelClient::Requests}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ModelClient::Services}
...
\end{figure}
\myparagraph{Classe Quiz}
Include la struttura del quiz.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-quiz.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-topics.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Services::Topics}
\end{figure}
\subsubsection{Quizzipedia::Client::ModelClient::Services::Questions}
...
\end{figure}
\myparagraph{Classe Column}
La classe descrive le colonne della domanda a collegamenti.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-column.pdf}}
...
\end{itemize}
\myparagraph{Classe CompletionQ}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-completionq.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Services::Questions::CompletionQ}
\end{figure}
\myparagraph{Classe GenericQuestion}
Descrive le parti comuni a tutti i tipi di domanda presenti nel sistema.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-genericquestion.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-matchingq.pdf}}
...
\end{itemize}
\myparagraph{Classe MultipleChoiceQ}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-multiplechoiceq.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Services::Questions::MultipleChoiceQ}
\end{figure}
\myparagraph{Classe ShortAnswerQ}
La struttura descrive le domande aperte, ovvero quelle la cui risposta consiste in un termine o una frase specifici.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-shortanswerq.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Services::Questions::ShortAnswerQ}
\end{figure}
\myparagraph{Classe TrueFalseQ}
Viene descritta la struttura delle domande che prevedono di decidere la veridicità di un'affermazione.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-services-questions-truefalseq.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Services::Questions::TrueFalseQ}
\end{figure}
\subsubsection{Quizzipedia::Client::ModelClient::Statistics}
...
\end{itemize}
\myparagraph{Classe QuestionGenerics}
...
\end{itemize}
\myparagraph{Classe QuestionStatistics}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-statistics-questionstatistics.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Statistics::QuestionStatistics}
\end{figure}
\myparagraph{Classe QuizGenerics}
...
\end{itemize}
\myparagraph{Classe QuizStatistics}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-statistics-quizstatistics.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Statistics::QuizStatistics}
\end{figure}
\myparagraph{Classe StudentStatistics}
Qui è memorizzata la struttura che permette di associare a un utente le statistiche riguardanti un quiz (voto, superamento).
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-statistics-studentstatistics.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Statistics::StudentStatistics}
\end{figure}
\subsubsection{Quizzipedia::Client::ModelClient::Users}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-users-norole.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Users::NoRole}
\end{figure}
\myparagraph{Classe Student}
Rappresenta uno studente del sistema e implementa le sue funzioni specifiche oltre a quelle ereditate da Utente.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-users-student.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Users::Student}
\end{figure}
\myparagraph{Classe Teacher}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-users-teacher.pdf}}
\caption{Schema Classe Quizzipedia::Client::ModelClient::Users::Teacher}
\end{figure}
\myparagraph{Classe User}
Questa è una classe astratta e raccoglie le funzionalità comuni a tutti gli utenti.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-modelclient-users-user.pdf}}
...
\end{itemize}
\subsubsection{Quizzipedia::Client::ViewClient::ViewClassManager}
...
\end{figure}
\myparagraph{Classe ViewModifyClass}
Presenta all'utente la pagina da cui sarà possibile modificare le informazioni su una classe esistente.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-viewclient-viewclassmanager-viewmodifyclass.pdf}}
\caption{Schema Classe Quizzipedia::Client::ViewClient::ViewClassManager::ViewModifyClass}
\end{figure}
\myparagraph{Classe ViewUsersClassList}
La classe si occupa di presentare una lista degli utenti iscritti alla classe e altre informazioni aggiuntive.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-viewclient-viewclassmanager-viewusersclasslist.pdf}}
\caption{Schema Classe Quizzipedia::Client::ViewClient::ViewClassManager::ViewUsersClassList}
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewQuestionManager}
...
\end{figure}
\myparagraph{Classe ViewModifyQuestion}
Gestisce la visualizzazione della pagina da cui è possibile modificare una domanda esistente.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-client-viewclient-viewquestionmanager-viewmodifyquestion.pdf}}
\caption{Schema Classe Quizzipedia::Client::ViewClient::ViewQuestionManager::ViewModifyQuestion}
\end{figure}
\myparagraph{Classe ViewQuestionList}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewQuizManager}
...
\end{figure}
\myparagraph{Classe ViewModifyQuiz}
...
\end{figure}
\myparagraph{Classe ViewQuizList}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewQuizSolver}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewQuizSolver::ViewQuestionSolver}
...
\end{figure}
\myparagraph{Classe ViewMatchingQ}
...
\end{figure}
\myparagraph{Classe ViewMultipleChoiceQ}
...
\end{figure}
\myparagraph{Classe ViewShortAnswerQ}
...
\end{figure}
\myparagraph{Classe ViewTrueFalseQ}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewRequests}
...
\end{figure}
\myparagraph{Classe RequestRole}
...
\end{figure}
\myparagraph{Classe ViewClassList}
...
\end{figure}
\myparagraph{Classe ViewRolesList}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewSearch}
...
\end{figure}
\myparagraph{Classe ViewSearchQuestion}
...
\end{figure}
\myparagraph{Classe ViewSearchQuiz}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewStatistics}
...
\end{figure}
\myparagraph{Classe ViewClassStats}
...
\end{figure}
\myparagraph{Classe ViewQuestionStats}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewTopicManager}
...
\end{figure}
\myparagraph{Classe ViewTopicList}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ViewClient::ViewUsers}
...
\end{figure}
\myparagraph{Classe PersonalData}
...
\end{figure}
\myparagraph{Classe Registration}
...
\end{figure}
\myparagraph{Classe ViewModifyUser}
...
\end{figure}
\myparagraph{Classe ViewUsersList}
...
\end{itemize}
\subsubsection{Quizzipedia::Client::ControllerClient::CtrlOrganization}
...
\end{figure}
\myparagraph{Classe CtrlInstitution}
...
\end{figure}
\myparagraph{Classe CtrlRequestRole}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ControllerClient::CtrlServices}
...
\end{figure}
\subsubsection{Quizzipedia::Client::ControllerClient::CtrlStatistics}
...
\end{figure}
\myparagraph{Classe CtrlUserManager}
...
\end{itemize}
\subsubsection{Quizzipedia::Server::ModelServer::Services1}
Il package racchiude i modelli necessari alla creazione di domande e quiz, i servizi principali offerti dal nostro prodotto.
\begin{figure}[H]
\centering
...
\end{figure}
\myparagraph{Classe Quiz1}
Include la struttura del quiz.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-quiz1.pdf}}
...
\end{figure}
\subsubsection{Quizzipedia::Server::ModelServer::Services1::Questions1}
Descrive il modo in cui sono strutturati i vari tipi di domande che l'utente può incontrare durante la creazione o la compilazione di quiz.
\begin{figure}[H]
\centering
...
\end{figure}
\myparagraph{Classe Column1}
La classe descrive le colonne della domanda a collegamenti.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-column1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::Column1}
\end{figure}
\myparagraph{Classe CompletationQ1}
Descrive le domande a completamento. Il docente fornirà un testo incompleto e una lista di possibili completamenti; lo studente dovrà inserire le parole adeguate nella giusta posizione.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-completationq1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::CompletationQ1}
\end{figure}
\myparagraph{Classe GenericQuestion1}
Descrive le parti comuni a tutti i tipi di domanda presenti nel sistema.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-genericquestion1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::GenericQuestion1}
\end{figure}
\myparagraph{Classe MatchingQ1}
La struttura descrive le domande a collegamento. L'utente dovrà formare la risposa collegando entrate da un numero variabile di colonne.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-matchingq1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::MatchingQ1}
\end{figure}
\myparagraph{Classe MultipleChoiceQ1}
La struttura descrive le domande a scelta multipla; viene presentata una lista di opzioni tra cui scegliere quelle corrette.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-multiplechoiceq1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::MultipleChoiceQ1}
\end{figure}
\myparagraph{Classe ShortAnswerQ1}
La struttura descrive le domande aperte, ovvero quelle la cui risposta consiste in un termine o una frase specifici.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-shortanswerq1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::ShortAnswerQ1}
\end{figure}
\myparagraph{Classe TrueFalseQ1}
Viene descritta la struttura delle domande che prevedono di decidere la veridicità di un'affermazione.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-modelserver-services1-questions1-truefalseq1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ModelServer::Services1::Questions1::TrueFalseQ1}
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer}
...
\end{itemize}
\subsubsection{Quizzipedia::Server::ControllerServer::AuthenticationManager}
...
\end{figure}
\myparagraph{Classe PasswordRecover}
...
\end{figure}
\myparagraph{Classe SessionController1}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-authenticationmanager-sessioncontroller1.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::AuthenticationManager::SessionController1}
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::ClassManager}
...
\end{figure}
\myparagraph{Classe ClassDeleter}
...
\end{figure}
\myparagraph{Classe ClassUpdater}
...
\end{figure}
\myparagraph{Classe FromClassRemover}
...
\end{figure}
\myparagraph{Classe InClassAdder}
...
\end{figure}
\myparagraph{Classe SessionController2}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-classmanager-sessioncontroller2.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::ClassManager::SessionController2}
\end{figure}
\myparagraph{Classe StudentsClassFetcher}
...
\end{figure}
\myparagraph{Classe TeachersClassFetcher}
...
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::ProfileManager}
...
\end{figure}
\myparagraph{Classe PasswordSetter}
...
\end{figure}
\myparagraph{Classe PersonalDataFetcher}
...
\end{figure}
\myparagraph{Classe PersonalDataSetter}
...
\end{figure}
\myparagraph{Classe PersonalQuizFetcher}
...
\end{figure}
\myparagraph{Classe SessionController3}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-profilemanager-sessioncontroller3.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::ProfileManager::SessionController3}
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::QuizManager}
...
\end{figure}
\myparagraph{Classe QuizGetter}
Ritorna un determinato quiz pronto per essere svolto da un utente .
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-quizmanager-quizgetter.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::QuizManager::QuizGetter}
\end{figure}
\myparagraph{Classe QuizUpdater}
...
\end{figure}
\myparagraph{Classe ResultsUpdater}
...
\end{figure}
\myparagraph{Classe SessionController4}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-quizmanager-sessioncontroller4.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::QuizManager::SessionController4}
\end{figure}
\myparagraph{Classe StatisticsUpdater}
...
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::RequestsManager}
...
\end{figure}
\myparagraph{Classe InsertClassRequestAdder}
...
\end{figure}
\myparagraph{Classe RoleRequestsAdder}
...
\end{figure}
\myparagraph{Classe SessionController5}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-requestsmanager-sessioncontroller5.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::RequestsManager::SessionController5}
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::SearchManager}
...
\end{figure}
\myparagraph{Classe QuizSearcher}
...
\end{figure}
\myparagraph{Classe SessionController6}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-searchmanager-sessioncontroller6.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::SearchManager::SessionController6}
\end{figure}
\subsubsection{Quizzipedia::Server::ControllerServer::StatisticsManager}
...
\end{figure}
\myparagraph{Classe QuestionStatisticsFetcher}
...
\end{figure}
\myparagraph{Classe QuizStatisticsFetcher}
...
\end{figure}
\myparagraph{Classe SessionController7}
Effettua il controllo sull'utente per verificare che egli sia in possesso dell'autorizzazione necessaria per compiere determinate richieste alla base di dati.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{ImgST/quizzipedia-server-controllerserver-statisticsmanager-sessioncontroller7.pdf}}
\caption{Schema Classe Quizzipedia::Server::ControllerServer::StatisticsManager::SessionController7}
\end{figure}
\myparagraph{Classe StudentStatisticsFetcher}
...
\end{figure}
\myparagraph{Classe TeacherStatisticsFetcher}
...
\end{figure}
\myparagraph{Classe TopicCreator}
...
\end{figure}
\myparagraph{Classe TopicEraser}
...
\end{figure}
\subsubsection{Quizzipedia::Server::RoutingManager}
...
\end{figure}
\myparagraph{Classe ClassRouter}
...
\end{figure}
\myparagraph{Classe ProfileRouter}
...
\end{figure}
\myparagraph{Classe RequestsRouter}
...
\end{figure}
\myparagraph{Classe SearchRouter}
...
\end{figure}
\myparagraph{Classe StatisticsRouter}
...
\end{figure}
\myparagraph{Classe TopicRouter}
