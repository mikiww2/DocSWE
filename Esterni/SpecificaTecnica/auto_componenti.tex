...
\item usata da \cls{Quizzipedia::Client::ViewModelClient::CtrlServices::CtrlQuiz} per gestire la compilazione e la creazione di quiz da parte dell'utente
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia::Client::ModelClient::Users::User} per tenere traccia degli utenti a cui le statistiche si riferiscono
\end{itemize}
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa \cls{Quizzipedia::Client::ModelClient::Services::Quiz} per gestire la compilazione e la creazione di quiz da parte dell'utente
\end{itemize}
