...
\item usata da Quizzipedia::Client::ModelClient::Requests::RequestClass per identificare la classe in cui l'utente vuole essere inserito
...
\paragraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Users per permettere agli utenti di effettuare richieste. Le richieste possono essere di ruolo o di classe
\end{itemize}
...
\item usata da Quizzipedia::Client::ViewModelClient::CtrlRequests::CtrlRequestClass per avere accesso alla lista di richieste e poterle gestire correttamente
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Requests::RequestClass per creare una lista in cui compaiano gli utenti e le classi in cui desiderano entrare
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Requests::ClassList per creare una lista in cui compaiano gli utenti e le classi in cui desiderano entrare
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organizations::Class per identificare la classe in cui l'utente vuole essere inserito
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ModelClient::Requests::RoleList per memorizzare una lista delle richieste di ruolo degli utenti di un istituto
\end{itemize}
...
\item usata da Quizzipedia::Client::ViewModelClient::CtrlRequests::CtrlRequestRole per gestire le richieste di ruolo pendenti
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Requests::RequestRole per memorizzare una lista delle richieste di ruolo degli utenti di un istituto
\end{itemize}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answercolumn.pdf}}
\caption[Schema Classe AnswerColumn]{Schema Classe Quizzipedia::Client::ModelClient::Services::Answer::AnswerColumn}
\end{figure}
\subsubsection{Classe AnswerCompletionQ}
Classe che si occupa di memorizzare le informazioni di un domanda CompletionQ risolta.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answercompletionq.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answermatchingq.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answermultiplechoiceq.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answerquestion.pdf}}
\caption[Schema Classe AnswerQuestion]{Schema Classe Quizzipedia::Client::ModelClient::Services::Answer::AnswerQuestion}
\end{figure}
\subsubsection{Classe AnswerQuiz}
Classe che si occupa di memorizzare le informazioni di un quiz completato e gestisce la verifica del suo superamento.
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answerquiz.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answershortanswerq.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/quizzipedia-client-modelclient-services-answer-answertruefalseq.pdf}}
...
\item usa Quizzipedia::Client::ModelClient::Requests per permettere agli utenti di effettuare richieste. Le richieste possono essere di ruolo o di classe
...
\end{itemize}
\subsubsection{Classe SendRequests}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewClient::ViewOrgManager::ViewModifyOrg per passare al controller i dati immessi dall'utente durante le operazioni di modifica, creazione o rimozione di una classe di un istituto
\item usata da Quizzipedia::Client::ViewClient::ViewSearch::ViewSearchClass per 
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Organizations::Class per avere accesso alla struttura della classe e potere quindi svolgere correttamente operazioni su di essa
\item usa Quizzipedia::Client::ModelClient::Organizations::Institution per avere accesso alla struttura dell'istituto e caricare correttamente l'istituto corrente
...
\item usa Quizzipedia::Client::ViewModelClient::CtrlOrganization::MyClass per memorizzare nello $scope le informazioni necessarie alla modifica, eliminazione o creazione di una classe
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlOrganization::CtrlInstitution per memorizzare nello $scope le informazioni necessarie alla modifica, eliminazione o creazione di una classe
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewClient::ViewRequests::SendRequests per aggiungi
\item usata da Quizzipedia::Client::ViewClient::ViewRequests::ViewClassList per aggiungi
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Requests::ClassList per avere accesso alla lista di richieste e poterle gestire correttamente
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Requests::RoleList per gestire le richieste di ruolo pendenti
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewClient::ViewUsers::RecoveryPw per passare al sistema le informazioni immesse dall'utente necessarie per il recupero della password
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewClient::ViewUsers::Registration per Raccogliere i dati inseriti dall'utente e passarli al controller
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ViewModelClient::CtrlUsers::MyUser per memorizzare, nello $scope, le informazioni necessarie alla registrazione dell'utente
\item usa Quizzipedia::Server::RoutingManager::AuthenticationRouter per passare al server le informazioni necessarie per la registrazione
\end{itemize}
...
\item usata da Quizzipedia::Client::ViewClient::ViewUsers::PersonalData per visualizzare le informazioni dell'utente e collegarlo alle funzioni principali
\item usata da Quizzipedia::Client::ViewClient::ViewUsers::ViewModifyPw per passare i dati inseriti dall'utente e necessari alla modifica della password (vecchia password, nuova password e conferma della nuova)
\end{itemize}
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Client::ModelClient::Users::Director per caricare un utente del tipo corretto
\item usa Quizzipedia::Client::ModelClient::Users::NoRole per caricare un utente del tipo corretto
\item usa Quizzipedia::Client::ModelClient::Users::Student per caricare un utente del tipo corretto
\item usa Quizzipedia::Client::ModelClient::Users::Teacher per caricare un utente del tipo corretto
\end{itemize}
...
\subparagraph{Entranti}
\begin{itemize}
\item usata da Quizzipedia::Client::ViewModelClient::CtrlUsers::CtrlRegistration per memorizzare, nello $scope, le informazioni necessarie alla registrazione dell'utente
\end{itemize}
...
\subsubsection{Componenti contenute}
\begin{itemize}
\item Quizzipedia::Server::ModelServer::Organizations
...
\end{itemize}
\subsection{Quizzipedia::Server::ModelServer::Organizations}
...
\item usata da Quizzipedia::Server::ModelServer::Organizations::Institution per 
...
\subparagraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Server::ModelServer::Organizations::Class per 
...
\paragraph{Uscenti}
\begin{itemize}
\item usa Quizzipedia::Server::ModelServer::Organizations per 
...
\item usata da Quizzipedia::Server::ControllerServer::StatisticsManager::TeacherStatisticsFetcher per verificare che l'utente sia un Docente
...
\begin{itemize}
\item usa Quizzipedia::Server::ControllerServer::SessionController per verificare che l'utente sia un Responsabile
\item usa Quizzipedia::Server::ModelServer::Organizations::Institution per 
\end{itemize}
