...
\def\VERSIONE{3.0}
\def\DATA{04.04.2016}
\def\REDATTORE{Michela De Bortoli}
\def\VERIFICATORE{Vassilikì Menarin \\ & Miki Violetto}
...
\begin{document}
	...
	\begin{itemize}
		\item \bold{\gl{Capitolato} d'appalto C5:} Quizzipedia: \gl{software} per la gestione di questionari \\gl{url}{<http://www.math.unipd.it/~tullio/IS-1/2015/Progetto/C5.\gl{pdf}>};
		\item \bold {Norme di progetto:} \doc{Norme di Progetto v1.00}.
	\end{itemize}
	
	\subsubsection{Riferimenti informativi}
	\begin{itemize}
		\item \bold{Materiale presentato durante il corso di \italics{Ingegneria del \gl{software}:}} \\gl{url}{http://www.math.unipd.it/~tullio/IS-1/2015/};
		...
		\item \bold{Guide to the \gl{Software} Engineering Body of Knowledge}: \\gl{url} {http://www.computer.org/\gl{web}/swebok/}
	...
	\subsubsection{Guasti \gl{hardware}}
	\myparagraph {Identificazione}
	...
	\subsubsection{Malfunzionamenti \gl{software}}
	\myparagraph {Identificazione}
	...
	\subsubsection{Problemi di \gl{versionamento}}
	\myparagraph {Identificazione}
	...
	\newpage
	\begin{figure}
		\includegraphics[scale=0.25]{Img/Grafici_Gantt/Analisi_dei_requisiti.\gl{pdf}}
	...
	\newpage
	\begin{figure}
		\includegraphics[scale=0.7]{Img/Grafici_Gantt/Raffinamento_requisiti.\gl{pdf}}
	...
	%GANTT 3
	\begin{figure}[!ht]
		\includegraphics[scale=0.2]{Img/Grafici_Gantt/Progettazione_architetturale.\gl{pdf}}
	...
	\newpage
	\begin{figure}[!ht]
		\includegraphics[scale=0.25]{Img/Grafici_Gantt/Progettazione(dett-cod).\gl{pdf}}
	...
	\newpage
	\begin{figure}[!ht]
		\includegraphics[scale=0.3]{Img/Grafici_Gantt/Validazione.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist03.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer03.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist04.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer04.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist05.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer05.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist07.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer07.\gl{pdf}}
	...
	C'è stato un problema protratto di salute di alcuni componenti del \gl{team} che ha portato a una variazione sul carico di ore degli altri componenti per bilanciare, quantificabile con un aumento di budget di €35. Considerato che la causa è stata per malattia e si è riusciti comunque a recuperare le ore perse, il gruppo ritiene di non dover modificare la pianificazione futura.
	...
	\subsubsection{Mancante o insufficiente conoscenza degli strumenti}
	Nelle prime fasi di progettazione sono sorti problemi per la scarsa conoscenza con \gl{StarUML} per quanto riguarda la creazione dei diagrammi di attività e \gl{package}. I problemi sono stati risolti nel tempo tramite lettura di guide dedicate da parte dei progettisti.
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist01.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer01.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Ist02.\gl{pdf}}
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.5]{Img/Grafici/Aer02.\gl{pdf}}
	...
	\begin{tabella}{l!{\VRule}c!{\VRule}c}
		...
		Vassilikì Menarin & 14.01.2016 & \includegraphics[scale=0.15]{Img/Firme/Viki.\gl{png}} \\
	...
	\begin{tabella}{l!{\VRule}c!{\VRule}c}
		...
		Vassilikì Menarin & 17.01.2016 & \includegraphics[scale=0.15]{Img/Firme/Viki.\gl{png}} \\
		Tullio Vardanega &  &  \\  		
	...
	\begin{tabella}{l!{\VRule}c!{\VRule}c}
		...
		Giacomo Beltrame & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Giacomo.\gl{png}} \\
		Rudy Berton & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Rudy.\gl{png}} \\
		Simone Boccato & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Simone.\gl{png}} \\
		Michela De Bortoli & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Michela.\gl{png}} \\
		Vassilikì Menarin & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Viki.\gl{png}} \\
		Filippo Tesser& 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Filippo.\gl{png}} \\
		Miki Violetto & 18.12.2015 & \includegraphics[scale=0.15]{Img/Firme/Miki.\gl{png}} \\	 		
