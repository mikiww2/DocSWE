...
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Selezione ente nella ricerca di quiz (UC1.8.2.2.2.1).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC1.8.2.2.2.1 Selezione ente nella ricerca di quiz}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Selezione ente nella ricerca di quiz.pdf}}
\caption{UC1.8.2.2.2.1 Selezione ente nella ricerca di quiz}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Studente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Selezione classe nella ricerca di quiz (UC1.8.2.2.2.1.1).
\end{enumerate}
\item \textbf{Descrizione}: lo studente deve poter selezionare/deselezionare un ente a cui appartiene per visualizzarne i quiz disponibili.
\item \textbf{Precondizione}: lo studente ha selezionato 'quiz privati' come parametro della sua ricerca.
\item \textbf{Postcondizione}: lo studente ha selezionato/deselezionato l'ente come parametro della sua ricerca di quiz.
\end{itemize}
\subsubsection{UC1.8.2.2.2.1.1 Selezione classe nella ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Studente.
\item \textbf{Scenario principale}: lo studente seleziona/deseleziona la classe desiderata.
\item \textbf{Descrizione}: lo studente deve poter selezionare/deselezionare una classe a cui appartiene per poterne visualizzare i quiz disponibili.
\item \textbf{Precondizione}: lo studente ha selezionato l'ente per cui cercare i quiz.
\item \textbf{Postcondizione}: lo studente ha selezionato/deselezionato la classe per cui cercare i quiz.
\end{itemize}
...
\item Gestione enti (UC2.7);
\item Gestione classe (UC2.8);
\item Lista richieste (UC2.9);
...
\item Eliminazione account utente (UC2.4.4);
\item Eliminazione account personale (UC2.4.5);
\item Eliminazione altri account (UC2.4.6);
\item Conferma eliminazione account (UC2.4.7);
\item Interruzione volontaria della modifica delle informazioni personali (UC2.4.8).
\end{enumerate}
...
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica nome (UC2.4.2.1);
\item Modifica cognome (UC2.4.2.2);
\item Modifica password (UC2.4.2.3);
\item Errore modifica password (UC2.4.2.4);
\item Conferma modifica informazioni personali (UC2.4.2.5).
\end{enumerate}
\item \textbf{Estensioni}:
\begin{itemize}
\item Interruzione volontaria della modifica delle informazioni personali (UC2.4.8).
...
\end{itemize}
\subsubsection{UC2.4.2.1 Modifica nome}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.2 Modifica cognome}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.3 Modifica password}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica password.pdf}}
\caption{UC2.4.2.3 Modifica password}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Inserimento vecchia password (UC2.4.2.3.1);
\item Inserimento nuova password (UC2.4.2.3.2);
\item Conferma inserimento nuova password (UC2.4.2.3.3);
\item Conferma modifica password (UC2.4.2.3.4).
\end{enumerate}
\item \textbf{Estensioni}:
\begin{itemize}
\item Errore modifica password (UC2.4.2.4).
...
\end{itemize}
\subsubsection{UC2.4.2.3.1 Inserimento vecchia password}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.3.2 Inserimento nuova password}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.3.3 Conferma inserimento nuova password}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.3.4 Conferma modifica password}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.2.4 Errore modifica password}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
\item \textbf{Scenario principale}: l'utente visualizza il messaggio di errore.
...
\end{itemize}
\subsubsection{UC2.4.2.5 Conferma modifica informazioni personali}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.4 Eliminazione account utente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.4.5 Eliminazione account personale}
\begin{itemize}
\item \textbf{Attori}: Responsabile, Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Conferma eliminazione account personale (UC2.4.5.1).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.4.5.1 Conferma eliminazione account personale}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.6 Eliminazione altri account}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Conferma eliminazione altri account (UC2.4.6.1).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.4.6.1 Conferma eliminazione altri account}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.4.7 Conferma eliminazione account}
\begin{itemize}
\item \textbf{Attori}: Responsabile, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.4.8 Interruzione volontaria della modifica delle informazioni personali}
\begin{itemize}
\item \textbf{Attori}: Utente Autenticato.
...
\end{itemize}
\subsubsection{UC2.7 Gestione enti}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Gestione enti.pdf}}
\caption{UC2.7 Gestione enti}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Creazione di un nuovo ente (UC2.7.1);
\item Modifica di un ente esistente (UC2.7.2);
\item Eliminazione di un ente (UC2.7.3).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.7.1 Creazione di un nuovo ente}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Creazione di un nuovo ente.pdf}}
\caption{UC2.7.1 Creazione di un nuovo ente}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Inserimento data di creazione (UC2.7.1.1);
\item Inserimento nome (UC2.7.1.2);
\item Conferma inserimento dati (UC2.7.1.3).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.7.1.1 Inserimento data di creazione}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.7.1.2 Inserimento nome}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.7.1.3 Conferma inserimento dati}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.7.2 Modifica di un ente esistente}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica di un ente esistente.pdf}}
\caption{UC2.7.2 Modifica di un ente esistente}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica nome ente (UC2.7.2.1);
\item Conferma modifica ente (UC2.7.2.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.7.2.1 Modifica nome ente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.7.2.2 Conferma modifica ente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.7.3 Eliminazione di un ente}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Eliminazione di un ente.pdf}}
\caption{UC2.7.3 Eliminazione di un ente}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Conferma eliminazione ente (UC2.7.3.1).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.7.3.1 Conferma eliminazione ente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\item Selezione ente (UC2.8.1.3);
\item Inserimento anno scolastico (UC2.8.1.4);
\item Conferma creazione classe (UC2.8.1.5).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.8.1.3 Selezione ente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.1.4 Inserimento anno scolastico}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.1.5 Conferma creazione classe}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica nome (UC2.8.2.1);
\item Modifica descrizione (UC2.8.2.2);
\item Modifica ente (UC2.8.2.3);
\item Modifica anno scolastico (UC2.8.2.4);
\item Conferma modifica classe (UC2.8.2.5).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.8.2.1 Modifica nome}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.2.2 Modifica descrizione}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.2.3 Modifica ente}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.2.4 Modifica anno scolastico}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.8.2.5 Conferma modifica classe}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.9 Lista richieste}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Lista richieste.pdf}}
\caption{UC2.9 Lista richieste}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Richieste inserimento nella classe (UC2.9.1);
\item Richieste ruoli (UC2.9.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.9.1 Richieste inserimento nella classe}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Richieste inserimento nella classe.pdf}}
\caption{UC2.9.1 Richieste inserimento nella classe}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Accettazione della richiesta di inserimento (UC2.9.1.1);
\item Annullamento della richiesta di inserimento (UC2.9.1.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.9.1.1 Accettazione della richiesta di inserimento}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.9.1.2 Annullamento della richiesta di inserimento}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.9.2 Richieste ruoli}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Richieste ruoli.pdf}}
\caption{UC2.9.2 Richieste ruoli}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Accettazione del ruolo (UC2.9.2.1);
\item Annullamento richiesta ruolo (UC2.9.2.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.9.2.1 Accettazione del ruolo}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
...
\end{itemize}
\subsubsection{UC2.9.2.2 Annullamento richiesta ruolo}
\begin{itemize}
\item \textbf{Attori}: Responsabile.
