...
\end{itemize}
\subsubsection{UC2.9.3.2 Annullamentorichiesta di inserimento di uno studente}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Inserire allegato.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Crea risposta.pdf}}
