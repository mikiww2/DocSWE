...
\item Ricerca di domande (UC1.8.4);
\item Ricerca di quiz (UC1.8.5).
\end{enumerate}
\item \textbf{Estensioni}:
\begin{itemize}
\item Interruzione volontaria della ricerca (UC1.12).
...
\end{itemize}
\subsubsection{UC1.8.4 Ricerca di domande}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Selezione parametri nella ricerca di domanda (UC1.8.4.1).
\end{enumerate}
\item \textbf{Scenario principale}: l'utente cerca delle domande.
\item \textbf{Descrizione}: l'utente deve poter cercare domande.
\item \textbf{Precondizione}: l'utente sta effettuando una ricerca.
\item \textbf{Postcondizione}: l'utente ha effettuato la ricerca di domande.
\end{itemize}
\subsubsection{UC1.8.4.1 Selezione parametri nella ricerca di domanda}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Selezione parametri nella ricerca di domanda.pdf}}
\caption{UC1.8.4.1 Selezione parametri nella ricerca di domanda}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Selezione argomenti nella ricerca delle domande (UC1.8.4.1.3);
\item Selezione livelli di difficoltà nella ricerca delle domande (UC1.8.4.1.4);
\item Selezione parole chiave nella ricerca di domande (UC1.8.4.1.5).
\end{enumerate}
\item \textbf{Descrizione}: l'utente deve poter personalizzare la ricerca di domande attraverso diversi parametri.
\item \textbf{Precondizione}: l'utente ha scelto di effettuare una ricerca di domande.
\item \textbf{Postcondizione}: l'utente ha selezionato i parametri desiderati nella ricerca di domande.
\end{itemize}
\subsubsection{UC1.8.4.1.3 Selezione argomenti nella ricerca delle domande}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}: l'utente seleziona/deseleziona gli argomenti delle domande.
\item \textbf{Descrizione}: l'utente deve poter selezionare/deselezionare uno o più argomenti, escludendo domande di argomenti non selezionati dalla ricerca.
\item \textbf{Precondizione}: l'utente sta personalizzando la ricerca di domande attraverso dei parametri.
\item \textbf{Postcondizione}: l'utente ha selezionato/deselezionato gli argomenti delle domande.
\end{itemize}
\subsubsection{UC1.8.4.1.4 Selezione livelli di difficoltà nella ricerca delle domande}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}: l'utente seleziona/deseleziona i livelli di difficoltà delle domande.
\item \textbf{Descrizione}: l'utente deve poter selezionare/deselezionare uno o più livelli di difficoltà, escludendo domande di livello di difficoltà non selezionato.
\item \textbf{Precondizione}: l'utente sta personalizzando la ricerca di domande attraverso dei parametri.
\item \textbf{Postcondizione}: l'utente ha selezionato/deselezionato i livelli di difficoltà delle domande.
\end{itemize}
\subsubsection{UC1.8.4.1.5 Selezione parole chiave nella ricerca di domande}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}: l'utente seleziona/deseleziona le parole chiave delle domande.
\item \textbf{Descrizione}: l'utente deve poter selezionare/deselezionare una o più parole chiave, escludendo le domande in cui le parole chiave immesse non compaiono nel titolo o nella descrizione.
\item \textbf{Precondizione}: l'utente sta personalizzando la ricerca delle domande attraverso dei parametri.
\item \textbf{Postcondizione}: l'utente ha selezionato/deselezionato le parole chiave delle domande.
\end{itemize}
\subsubsection{UC1.8.5 Ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Errore permesso di accesso a quiz privati (UC1.8.5.3);
\item Selezione parametri di ricerca di quiz (UC1.8.5.4).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC1.8.5.3 Errore permesso di accesso a quiz privati}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC1.8.5.4 Selezione parametri di ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Selezione quiz pubblico (UC1.8.5.4.1);
\item Selezione quiz privato (UC1.8.5.4.2);
\item Selezione argomenti nella ricerca di quiz (UC1.8.5.4.3);
\item Selezione livelli di difficoltà nella ricerca di quiz (UC1.8.5.4.4);
\item Selezione parole chiave nella ricerca di quiz (UC1.8.5.4.5).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC1.8.5.4.1 Selezione quiz pubblico}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC1.8.5.4.2 Selezione quiz privato}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC1.8.5.4.3 Selezione argomenti nella ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC1.8.5.4.4 Selezione livelli di difficoltà nella ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
...
\end{itemize}
\subsubsection{UC1.8.5.4.5 Selezione parole chiave nella ricerca di quiz}
\begin{itemize}
\item \textbf{Attori}: Utente, Utente Autenticato.
