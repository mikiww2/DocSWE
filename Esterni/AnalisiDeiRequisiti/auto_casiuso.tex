...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Selezione parametri di ricerca quiz.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Eliminazione account.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Invio richiesta di accettazione classe come docente.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Invio richiesta di accettazione classe come studente.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica ente.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica nome ente.pdf}}
...
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Eliminazione classe.pdf}}
...
\item Errore numero risposte modifica (UC2.10.9);
\item Interruzione volontaria della modifica della domanda (UC2.10.10);
\item Modifica domanda vero o falso (UC2.10.11);
\item Modifica domanda risposta multipla (UC2.10.12);
\item Modifica domanda a risposta aperta (UC2.10.13);
\item Modifica domanda a completamento testo (UC2.10.14);
\item Modifica domanda a collegamenti (UC2.10.15);
\item Eliminazione domanda (UC2.10.16);
\item Modifica domanda (UC2.10.17).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.9 Errore numero risposte modifica}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\item \textbf{Postcondizione}: il docente visualizza il messaggio d'errore.
\end{itemize}
\subsubsection{UC2.10.10 Interruzione volontaria della modifica della domanda}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.11 Modifica domanda vero o falso}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda vero o falso.pdf}}
\caption{UC2.10.11 Modifica domanda vero o falso}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica veridicità della domanda (UC2.10.11.1).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.10.11.1 Modifica veridicità della domanda}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12 Modifica domanda risposta multipla}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda risposta multipla.pdf}}
\caption{UC2.10.12 Modifica domanda risposta multipla}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Aggiungere una risposta (UC2.10.12.1);
\item Modificare una risposta (UC2.10.12.2);
\item Eliminare una risposta (UC2.10.12.3).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.10.12.1 Aggiungere una risposta}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Aggiungere una risposta.pdf}}
\caption{UC2.10.12.1 Aggiungere una risposta}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Upload file multimediale della risposta (UC2.10.12.1.1);
\item Inserimento risposta testuale (UC2.10.12.1.2);
\item Selezione veridicità della risposta (UC2.10.12.1.3).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.12.1.1 Upload file multimediale della risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente esegue l'upload di un'immagine, un video o un file audio.
\item \textbf{Inclusioni}:
...
\end{itemize}
\subsubsection{UC2.10.12.1.2 Inserimento risposta testuale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12.1.3 Selezione veridicità della risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12.2 Modificare una risposta}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modificare una risposta.pdf}}
\caption{UC2.10.12.2 Modificare una risposta}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Upload del file multimediale (UC2.10.12.2.1);
\item Modifica veridicità risposta (UC2.10.12.2.2);
\item Modifica testo risposta (UC2.10.12.2.3).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.12.2.1 Upload del file multimediale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12.2.2 Modifica veridicità risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12.2.3 Modifica testo risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.12.3 Eliminare una risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.13 Modifica domanda a risposta aperta}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda a risposta aperta.pdf}}
\caption{UC2.10.13 Modifica domanda a risposta aperta}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica della risposta (UC2.10.13.1).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.10.13.1 Modifica della risposta}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.14 Modifica domanda a completamento testo}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda a completamento testo.pdf}}
\caption{UC2.10.14 Modifica domanda a completamento testo}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica testo incompleto (UC2.10.14.1);
\item Modifica parole esistenti (UC2.10.14.2);
\item Elimina parole (UC2.10.14.3).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.10.14.1 Modifica testo incompleto}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.14.2 Modifica parole esistenti}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.14.3 Elimina parole}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.15 Modifica domanda a collegamenti}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda a collegamenti.pdf}}
\caption{UC2.10.15 Modifica domanda a collegamenti}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Inserire ennupla (UC2.10.15.1);
\item Elimina ennupla (UC2.10.15.2).
\end{enumerate}
...
\end{enumerate}
\end{itemize}
\subsubsection{UC2.10.15.1 Inserire ennupla}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Inserire ennupla.pdf}}
\caption{UC2.10.15.1 Inserire ennupla}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Aggiungere parte iniziale (UC2.10.15.1.1);
\item Aggiungere parte finale (UC2.10.15.1.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.15.1.1 Aggiungere parte iniziale}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Aggiungere parte iniziale.pdf}}
\caption{UC2.10.15.1.1 Aggiungere parte iniziale}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Upload file parte iniziale (UC2.10.15.1.1.1);
\item Aggiungere testo parte iniziale (UC2.10.15.1.1.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.15.1.1.1 Upload file parte iniziale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\item \textbf{Postcondizione}: il docente ha eseguito l'upload del file multimediale.
\end{itemize}
\subsubsection{UC2.10.15.1.1.2 Aggiungere testo parte iniziale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.15.1.2 Aggiungere parte finale}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Aggiungere parte finale.pdf}}
\caption{UC2.10.15.1.2 Aggiungere parte finale}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Upload file parte finale (UC2.10.15.1.2.1);
\item Aggiungere testo parte finale (UC2.10.15.1.2.2).
\end{enumerate}
...
\end{itemize}
\subsubsection{UC2.10.15.1.2.1 Upload file parte finale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\item \textbf{Postcondizione}: il docente ha eseguito l'upload del file multimediale.
\end{itemize}
\subsubsection{UC2.10.15.1.2.2 Aggiungere testo parte finale}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.15.2 Elimina ennupla}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.16 Eliminazione domanda}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\end{itemize}
\subsubsection{UC2.10.17 Modifica domanda}
\begin{figure}[H]
\centering
\noindent\makebox[\textwidth]{\includegraphics[width=\textwidth]{Img/UC Modifica domanda.pdf}}
\caption{UC2.10.17 Modifica domanda}
\end{figure}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}:
\begin{enumerate}
\item Modifica titolo domanda (UC2.10.17.1);
\item Modifica descrizione aggiuntiva (UC2.10.17.2);
\item Modifica argomento della domanda (UC2.10.17.3);
\item Modifica livello difficoltà (UC2.10.17.4);
\item Modifica allegato (UC2.10.17.5);
\item Modifica parole chiave (UC2.10.17.6).
\end{enumerate}
\item \textbf{Estensioni}:
\begin{itemize}
\item Errore numero risposte modifica (UC2.10.9);
...
\end{itemize}
\subsubsection{UC2.10.17.1 Modifica titolo domanda}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente pu`o modificare il titolo della domanda che ha selezionato.
\item \textbf{Descrizione}: il docente deve poter modificare il titolo della domanda che ha selezionato.
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato il titolo.
\item \textbf{Postcondizione}: il docente ha modificato il titolo della domanda.
\end{itemize}
\subsubsection{UC2.10.17.2 Modifica descrizione aggiuntiva}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente può modificare la descrizione aggiuntiva della domanda
selezionata.
\item \textbf{Descrizione}: il docente deve poter modificare la descrizione aggiuntiva della domanda
selezionata.
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato la descrizione aggiuntiva.
\item \textbf{Postcondizione}: il docente ha modificato la descrizione aggiuntiva.
\end{itemize}
\subsubsection{UC2.10.17.3 Modifica argomento della domanda}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente può modificare l'argomento della domanda selezionata
semplicemente selezionando un argomento tra quelli disponibili.
...
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato l'argomento della domanda.
\item \textbf{Postcondizione}: il docente ha modificato l'argomento della domanda selezionata.
\end{itemize}
\subsubsection{UC2.10.17.4 Modifica livello difficoltà}
\begin{itemize}
\item \textbf{Attori}: Docente.
...
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato il livello di difficoltà.
\item \textbf{Postcondizione}: il docente ha modificato il livello di difficoltà della domanda selezionata.
\end{itemize}
\subsubsection{UC2.10.17.5 Modifica allegato}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente può modificare l'allegato della domanda eseguendo l'upload
di un file multimediale (immagine, audio, video).
\item \textbf{Descrizione}: il docente ha la possibilità di modificare l'allegato della domanda eseguendo
l'upload di un file multimediale.
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato l'allegato della domanda.
\item \textbf{Postcondizione}: il docente ha modificato l'allegato della domanda.
\end{itemize}
\subsubsection{UC2.10.17.6 Modifica parole chiave}
\begin{itemize}
\item \textbf{Attori}: Docente.
\item \textbf{Scenario principale}: il docente modifica le parole chiave della domanda.
\item \textbf{Descrizione}: il docente deve poter modificare le parole chiave della domanda che sta
modificando.
\item \textbf{Precondizione}: il docente ha iniziato la modifica di una domanda ma non ha ancora
modificato le parole chiave.
