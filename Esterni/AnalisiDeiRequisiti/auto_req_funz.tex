...
ROF3 & Funzionale \linebreak obbligatorio & Un utente deve poter effettuare una richiesta di recupero password, grazie alla quale gli sarà inviata via email una password temporanea & UC1.5 \linebreak interna \\
...
ROF14.4.1 & Funzionale \linebreak obbligatorio & Il responsabile deve poter eliminare dal proprio ente gli utenti da lui gestiti & UC2.4.4 \linebreak interna \\
...
ROF15.1.4.1 & Funzionale \linebreak obbligatorio & Nel caso il docente scelga il permesso privato per il quiz, egli dovrà poter selezionare le classi a cui riservare lo svolgimento del quiz & UC2.2.1.4.2.1 \linebreak interna \\
...
ROF16 & Funzionale \linebreak obbligatorio & L'utente senza ruolo, lo studente e il docente possono effettuare varie richieste al responsabile di un ente & UC2.5 \linebreak interna \\
ROF16.1 & Funzionale \linebreak obbligatorio & L'utente senza ruolo può richiedere di assumere il ruolo di docente in un ente & UC2.5.1 \linebreak interna \\
ROF16.2 & Funzionale \linebreak obbligatorio & L'utente senza ruolo può richiedere di assumere il ruolo di studente in un ente & UC2.5.2 \linebreak interna \\
...
ROF17.4 & Funzionale \linebreak obbligatorio & Il responsabile può gestire le richieste di attribuzione del ruolo di studente & UC2.9.4 \linebreak interna \\
ROF17.4.1 & Funzionale \linebreak obbligatorio & Il responsabile può accettare la richiesta di attibuzione del ruolo di studente & UC2.9.4.1 \linebreak interna \\
ROF17.4.2 & Funzionale \linebreak obbligatorio & Il responsabile può rifiutare la richiesta di attibuzione del ruolo di studente & UC2.9.4.2 \linebreak interna \\
ROF18 & Funzionale \linebreak obbligatorio & Il sistema deve mettere a disposizione del responsabile delle funzionalità per la gestione degli argomenti & UC2.3 \linebreak interna \\
...
ROF31.1.6 & Funzionale \linebreak obbligatorio & La creazione di ogni tipo di domanda permette l'inserimento di parole chiave & UC2.10.1.6 \linebreak interna \\
...
ROF31.15 & Funzionale \linebreak obbligatorio & Il docente deve poter eliminare una domanda & UC2.10.16 \linebreak interna \\
...
RZF15.2 & Funzionale \linebreak opzionale & Il docente deve poter modificare un quiz esistente & UC2.2.2 \linebreak capitolato \\
RZF15.2.1 & Funzionale \linebreak opzionale & Il docente può modificare il titolo del quiz & UC2.2.2.4 \linebreak interna \\
RZF15.2.2 & Funzionale \linebreak opzionale & Il docente può modificare l'argomento del quiz & UC2.2.2.5 \linebreak interna \\
RZF15.2.3 & Funzionale \linebreak opzionale & Il docente può modificare la descrizione del quiz & UC2.2.2.6 \linebreak interna \\
RZF15.2.4 & Funzionale \linebreak opzionale & Il docente può specificare e modificare il permesso del quiz & UC2.2.2.1 \linebreak interna \\
RZF15.2.4.1 & Funzionale \linebreak opzionale & Il docente può specificare un permesso 'pubblico' per il quiz & UC2.2.2.1.1 \linebreak interna \\
RZF15.2.4.2 & Funzionale \linebreak opzionale & Il docente può specificare un permesso 'privato' per il quiz  & UC2.2.2.1.2 \linebreak interna \\
RZF15.2.4.2.1 & Funzionale \linebreak opzionale & Il docente può specificare una o più classi a cui permette lo svolgimento del quiz & UC2.2.2.1.2.1 \linebreak interna \\
RZF15.2.5 & Funzionale \linebreak opzionale & il docente deve poter inserire una domanda nel quiz & UC2.2.2.2 \linebreak capitolato \\
RZF15.2.5.1 & Funzionale \linebreak opzionale & Il docente può cercare una domanda esistente e inserirla nel quiz & UC1.8 \linebreak interna \\
RZF15.2.5.2 & Funzionale \linebreak opzionale & Il docente può creare una nuova domanda e inserirla nel quiz & UC2.10.1 \linebreak interna \\
RZF15.2.6 & Funzionale \linebreak opzionale & Il docente deve poter rimuovere una domanda dal quiz & UC2.2.2.3 \linebreak interna \\
RZF15.2.7 & Funzionale \linebreak opzionale & Il sistema notifica l'utente se si è verificato un errore durante la modifica del quiz & UC2.2.3 \linebreak interna \\
RZF15.2.8 & Funzionale \linebreak opzionale & Il docente può modificare le parole chiave del quiz & UC2.2.2.8 \linebreak interna \\
...
RZF31.8 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda da lui creata & UC2.10.17 \linebreak interna \\
RZF31.8.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificare il titolo della domanda & UC2.10.17.1 \linebreak interna \\
RZF31.8.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificare la descrizione aggiuntiva & UC2.10.17.2 \linebreak interna \\
RZF31.8.3 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificare l'argomento della domanda & UC2.10.17.3 \linebreak interna \\
RZF31.8.4 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificare il livello di difficoltà della domanda & UC2.10.17.4 \linebreak interna \\
RZF31.8.5 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificare l'allegato precedentemente inserito & UC2.10.17.5 \linebreak interna \\
RZF31.8.6 & Funzionale \linebreak opzionale & Il docente, durante la modifica di ogni tipo di domanda, può modificre le parole chiave della domanda & UC2.10.17.6 \linebreak interna \\
RZF31.9 & Funzionale \linebreak opzionale & Il docente può interrompere volontariamente la modifica di una domanda & UC2.10.10 \linebreak interna \\
RZF31.10 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda di tipo vero o falso da lui creata & UC2.10.11 \linebreak interna \\
RZF31.10.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda di tipo vero o falso, deve poter modificare la veridicità della domanda & UC2.10.11.1 \linebreak interna \\
RZF31.11 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda a risposta multipla da lui creata & UC2.10.12 \linebreak interna \\
RZF31.11.1 & Funzionale \linebreak opzionale & Il docente,durante la modifica di una domanda a risposta multipla, deve poter aggiungere una risposta testuale, oppure una risposta multimediale e indicare la sua veridicità & UC2.10.12.1 \linebreak interna \\
RZF31.11.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a risposta multipla, deve poter modificare una risposta & UC2.10.12.2 \linebreak interna \\
RZF31.11.2.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una risposta a una domanda a risposta multipla, deve poter modificare il testo della risposta & UC2.10.12.2.3 \linebreak interna \\
RZF31.11.2.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una risposta a una domanda a risposta multipla, deve poter modificare la veridicità della risposta & UC2.10.12.2.2 \linebreak interna \\
RZF31.11.2.3 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una risposta a una domanda a risposta multipla, deve poter cambiare la risposta multimediale caricando un nuovo file audio o video o immagine & UC2.10.12.2.1 \linebreak interna \\
RZF31.11.3 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a risposta multipla, deve poter eliminare una risposta & UC2.10.12.3 \linebreak interna \\
RZF31.12 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda a risposta aperta da lui creata & UC2.10.13 \linebreak interna \\
RZF31.12.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a risposta aperta, può modificare il testo della risposta & UC2.10.13.1 \linebreak interna \\
RZF31.13 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda a completamento testo da lui creata & UC2.10.14 \linebreak interna \\
RZF31.13.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a completamento testo, può modificare il testo incompleto della domanda, specificando sempre gli spazi vuoti & UC2.10.14.1 \linebreak interna \\
RZF31.13.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a completamento testo, può modificare l'insieme di parole associate al testo incompleto & UC2.10.14.2 \linebreak interna \\
RZF31.13.3 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a completamento testo, può eliminare alcune parole associate al testo incompleto & UC2.10.14.3 \linebreak interna \\
RZF31.14 & Funzionale \linebreak opzionale & Il docente deve poter modificare una domanda a collegamenti da lui creata & UC2.10.15 \linebreak interna \\
RZF31.14.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a collegamenti, può aggiungere una risposta & UC2.10.15.1 \linebreak interna \\
RZF31.14.1.1 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domandaa collegamenti, può aggiungere la parte iniziale di una risposta che può essere un file multimediale oppure risposta testuale & UC2.10.15.1.1 \linebreak interna \\
RZF31.14.1.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a collegamenti, può aggiungere la parte finale di una risposta che può essere un file multimediale oppure una risposta testuale & UC2.10.15.1.2 \linebreak interna \\
RZF31.14.2 & Funzionale \linebreak opzionale & Il docente, durante la modifica di una domanda a collegamenti, può eliminare una risposta & UC2.10.15.2 \linebreak interna \\
\rowcolor{white}
