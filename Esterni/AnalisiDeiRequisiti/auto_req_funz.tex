...
ROF12.2 & Funzionale \linebreak obbligatorio & L'utente può decidere se ricercare solo domande o solo quiz indicando se i quiz che vuole cercare sono pubblici o privati & interna \\
...
ROF15.2.5.2 & Funzionale \linebreak obbligatorio & Il docente può creare una nuova domanda e inserirla nel quiz & UC2.4.1 \linebreak interna \\
...
ROF16.1 & Funzionale \linebreak obbligatorio & Il docente deve poter creare una nuova domanda & UC2.4.1 \linebreak capitolato \\
ROF16.1.1 & Funzionale \linebreak obbligatorio & La creazione della domande richiede l'inserimento del titolo della domanda & UC2.4.1.1 \linebreak interna \\
ROF16.1.2 & Funzionale \linebreak obbligatorio & La creazione della domande richiede l'inserimento del livello di difficoltà della domanda & UC2.4.1.2 \linebreak interna \\
ROF16.1.3 & Funzionale \linebreak obbligatorio & La creazione della domande richiede la selezione dell'argomento della domanda & UC2.4.1.4 \linebreak interna \\
ROF16.1.4 & Funzionale \linebreak obbligatorio & La creazione della domande richiede la selezione del tipo della domanda & UC2.4.1.3 \linebreak interna \\
...
ROF16.2 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda da lui inserita & UC2.4.8 \linebreak capitolato \\
ROF16.2.1 & Funzionale \linebreak obbligatorio & Il docente può modificare il titolo della domanda & UC2.4.8.1 \linebreak interna \\
ROF16.2.2 & Funzionale \linebreak obbligatorio & Il docente può modificare il livello di difficoltà della domanda & UC2.4.8.2 \linebreak interna \\
ROF16.2.3 & Funzionale \linebreak obbligatorio & Il docente può modificare l'argomento della domanda & UC2.4.8.4 \linebreak interna \\
ROF16.2.4 & Funzionale \linebreak obbligatorio & Il docente può modificare il testo aggiuntivo della domanda & UC2.4.8.5 \linebreak interna \\
ROF16.2.5 & Funzionale \linebreak obbligatorio & Il docente può modificare il tipo della domanda & UC2.4.8.3 \linebreak interna \\
ROF16.2.6 & Funzionale \linebreak obbligatorio & Il docente può inserire un contenitore in varie sezioni della domanda & UC2.4.8.6 \linebreak interna \\
ROF16.2.6.1 & Funzionale \linebreak obbligatorio & Il docente può inserire un contenitore di tipo casella di testo & UC2.4.8.7 \linebreak interna \\
ROF16.2.6.2 & Funzionale \linebreak obbligatorio & Il docente può inserire un contenitore di tipo 'allegato' & UC2.4.8.8 \linebreak interna \\
ROF16.2.6.2.1 & Funzionale \linebreak obbligatorio & Il docente può caricare allegati di tipo 'immagine', 'file audio', 'file video' & UC2.4.8.8.1 \linebreak interna \\
ROF16.2.7 & Funzionale \linebreak obbligatorio & Il docente può rimuovere un contenitore dalla sezione della domanda in cui è stato inserito & UC2.4.8.9 \linebreak interna \\
ROF16.3 & Funzionale \linebreak obbligatorio & Il docente deve poter eliminare una domanda & UC2.4.7 \linebreak capitolato \\
ROF16.4 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda di tipo 'vero o falso' & UC2.4.2 \linebreak capitolato \\
ROF16.4.1 & Funzionale \linebreak obbligatorio & Il docente può modificare la veridicità della domanda, indicando se la risposta corretta è 'vero' o 'falso' & UC2.4.2.1 \linebreak interna \\
ROF16.5 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda di tipo 'risposta multipla' & UC2.4.3 \linebreak capitolato \\
ROF16.5.1 & Funzionale \linebreak obbligatorio & Il docente può modificare le risposte attraverso l'inserimento e la rimozione di contenitori & UC2.4.3.1 \linebreak interna \\
ROF16.5.2 & Funzionale \linebreak obbligatorio & Il docente può selezionare le risposte corrette. Una risposta selezionata è considerata corretta, una risposta non selezionata è considerata errata.  & UC2.4.3.2 \linebreak interna \\
ROF16.6 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda di tipo 'collegamenti' & UC2.4.4 \linebreak capitolato \\
ROF16.6.1 & Funzionale \linebreak obbligatorio & Il docente può modificare le risposte della domanda a collegamenti attraverso l'inserimento e la rimozione di contenitori & UC2.4.4.1 \linebreak interna \\
ROF16.6.2 & Funzionale \linebreak obbligatorio & Il docente può gestire le associazioni fra le risposte. Se due risposte sono associate il loro collegamento è considerato corretto, se due risposte non sono associate il loro collegamento è considerato errato & UC2.4.4.2 \linebreak interna \\
ROF16.7 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda di tipo 'risposta aperta' & UC2.4.5 \linebreak capitolato \\
ROF16.7.1 & Funzionale \linebreak obbligatorio & Il docente può gestire la risposta corretta della domanda a risposta aperta, inserendola o modificandola in forma testuale  & UC2.4.5.1 \linebreak interna \\
ROF16.8 & Funzionale \linebreak obbligatorio & Il docente deve poter modificare una domanda di tipo 'completamento testo' & UC2.4.6 \linebreak capitolato \\
ROF16.8.1 & Funzionale \linebreak obbligatorio & Il docente può inserire uno spazio vuoto nel testo che dovrà essere associato a una risposta & UC2.4.6.1 \linebreak interna \\
ROF16.8.2 & Funzionale \linebreak obbligatorio & Il docente può rimuovere uno spazio vuoto dal testo & UC2.4.6.2 \linebreak interna \\
ROF16.8.3 & Funzionale \linebreak obbligatorio & Il docente può modificare le risposte della domanda a completamento testo attraverso l'inserimento e la rimozione di contenitori & UC2.4.6.3 \linebreak interna \\
ROF16.8.4 & Funzionale \linebreak obbligatorio & Il docente può gestire l'associazione fra spazi e risposte. Se uno spazio e una risposta sono associati, inserire la risposta in quello spazio è considerato corretto. Se uno spazio e una risposta non sono associati, inserire la risposta in quello spazio è considerato errato & UC2.4.6.4 \linebreak interna \\
...
RDF19.2 & Funzionale \linebreak desiderabile & Il docente deve poter modificare un argomento esistente & UC2.3.2 \linebreak interna \\
RDF19.2.1 & Funzionale \linebreak desiderabile & La modifica di un argomento richiede l'inserimento del nuovo nome dell'argomento & UC2.3.2.1 \linebreak interna \\
