...
Il codice identificativo dei test di integrazione è: \centra{TI[codice univoco]}
...
Il codice identificativo dei test di sistema è: \centra{TS[tipo requisito][codice requisito]}
...
Il codice identificativo per tale tipo di test è: \centra{TV[tipo requisito][codice requisito]}
