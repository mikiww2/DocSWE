...
\begin{itemize}
	\item \textbf{Guida utilizzo \gl{Git}}: \\gl{url}{https://www.atlassian.com/\gl{git}/tutorials/};
	\item \textbf{Gitflow Workflow}: \\gl{url}{https://www.atlassian.com/\gl{git}/tutorials/comparing-workflows/gitflow-workflow};
	\item \textbf{GNU AGPLv3}: \\gl{url}{http://www.gnu.org/licenses/agpl-3.0.\gl{html}}.
\end{itemize}
...
\end{itemize}
Infine devono essere descritti i vari \gl{design pattern} che verranno utilizzati e il tracciamento requisito-componente atto a controllare lo stato di avanzamento del progetto.
...
Il codice deve seguire le linee guida Google reperibili all'indirizzo \\gl{url}{https://\gl{github}.com/google/styleguide}. I nomi delle variabili e classi deve essere in inglese, mentre i commenti in italiano.
...
\begin{figure}[!h]
	\includegraphics[width=\textwidth]{Img/docflow.\gl{png}}
...
\begin{figure}[!h]
	\includegraphics[width=\textwidth]{Img/flowticket.\gl{png}}
