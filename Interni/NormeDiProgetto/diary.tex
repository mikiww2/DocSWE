\begin{diario}
	\recap{Approvazione del documento}{Giacomo Beltrame}{Responsabile}{????????}{4.0}
	\recap{Verifica del documento}{Miki Violetto}{Verificatore}{?????????}{3.4}
	\recap{Incremento sezioni 2.2.2.4 e 3.2.1.2}{Rudy Berton}{Progettista}{???????????}{3.3}
	\recap{Incremento sezioni 2.2.1.2 e 2.2.3}{Filippo Tesser}{Progettista}{?????????}{3.2}
	\recap{Revisione correttiva dei contenuti}{Rudy Berton}{Progettista}{26.04.2016}{3.1}
